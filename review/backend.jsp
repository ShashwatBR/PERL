...
.heading ul li a:hover::before {
  ...
  background-color: rgb(243, 168, 7);
    ...
    <body>
        <%
            String name,address,book,mail;
            Connection connect;
            Class.forName("org.apache.derby.jdbc.ClientDriver");
            connect=DriverManager.getConnection("jdbc:derby://localhost:1527/e-book","sanjay","Sanjay@12");
       name=request.getParameter("name");
            address=request.getParameter("address");
            book=request.getParameter("time");
            mail=request.getParameter("mail");
            PreparedStatement st=connect.prepareStatement("INSERT INTO SANJAY.CHECKOUT(USERNAME,ADDRESS,BOOK_NAME,MAIL_ID)VALUES('"+name+"','"+address+"','"+book+"','"+mail+"')");
            st.executeUpdate();
            if(st!=null){
                st.close();
            }
 ...
 <header>
    ...
    <center>
        ...
        <h1> To track your order contact us</h1>
    </center>
    </body>
</html>
