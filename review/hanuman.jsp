                ...
                <div class="col-6">
                    <div class="product-image">
                        <div class="product-image-main">
                            <img src="https://cdn.exoticindia.com/images/products/original/books/hanuman_the_most_sagacious_idh621.jpg" alt="" id="product-main-image">
                        </div>
                ...
                <div class="col-6">
                    ...
                    <div class="product">
                        ...
                        <div class="product-price">
                            <span class="offer-price">$9.1</span>
                            <span class="sale-price">$14.8</span>
                        </div>

                        <div class="product-details">
                            <h3>Description</h3>
                            <p>Hanuman is one of the central characters of the Hindu epic Ramayana. He is an ardent devotee of Rama and one of the Chiranjivis. Hanuman is regarded to be the son of the wind-god Vayu, who in several stories played a direct role in Hanuman's birth and considered to be an incarnation of Shiva in Shaivism. Hanuman is mentioned in several other texts, such as the epic Mahabharata and the various Puranas. </p>
